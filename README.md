...
Авторська робота репозиторію поширюється під [ВОЛЬНІСТЮ](LICENSE). Сторонній
код і дані — лише case-by-case, з провенансом і ревʼю їхніх власних ліцензій
(chess.js виключено, див. `NOTICE-third-party.md`).
